...
Native **Android** app (Kotlin) — the mobile client of "Finanzas Independientes". It consumes a REST API (contract in `README-FRONTEND.md`). Setup, run, and troubleshooting live in `README-DEV.md`; architecture in `README.md`. Read those for anything not covered here.
