...
> El catálogo canónico de códigos `code` está en [README-READINESS.md](../api-finanzas-backend/README-READINESS.md).
...
Catálogo canónico y siempre actualizado en [README-READINESS.md](../api-finanzas-backend/README-READINESS.md). Resumen:
